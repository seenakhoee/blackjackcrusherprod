          ...
          <div class={styles.card}>
            <div className={styles.customCard}>
              ...
              <div className={styles.customCard__details}>
                ...
                <ul>
                  <li>Step 1. Assigns a negative, positive, or zero value to the cards.</li>
                  <li>Step 2. Maintain the ‘running count’ based on the cards dealt in the game.</li>
                  <li>Step 3. Convert the 'running count' into the 'true count'. Alter your your bets depending on their advantage.</li>
